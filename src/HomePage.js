...
const HomePage = () => {
    ...
    return (
        <div>
            {posts.map((post) => (
                <div key={post.id + 1} className='card col-sm-4 d-inline-block m-1 p-2 border border-dark shadow'>
                    ...
                    <div>
                        {post.comments.map((comment) => (
                            <div key={post.id+(comment.id+1)} className='card col-12 d-inline-block m-1 p-2 border border-dark shadow'>
