    ...
    return (
        ...
        <div className="mt-5 bg-dark text-light col-12 vh-100 text-center">
            ...
            <form onSubmit={async (e)=>{
                ...
                await fetch(`${url}/UserProfile/ForgetPasswordEmailSender?email=${e.target.elements.email.value}&url=${url2}/ForgatePassword/`,{method:"POST", headers:{'content-type': 'application/json'}})
                .catch((e)=>{alert(e)})
                .finally(()=>{
